...
export default function Hero() {
  return (
    <section id="Gaia-consortium" className="justify-start flex-row">
      ...
      /> */}
      <div className="flex flex-col gap-16 w-[830px] h-full justify-center py-20 mt-56 md:mt-0">
        <h1 className="bg-gradient-to-bl from-lightBlue via-skyBlue to-darkBlue bg-clip-text text-transparent">
          Gaia Consortium
        </h1>
        <p className="text-xl">
          We&apos;re a group of science and tech organizations collaborating to create a universal system for
          decentralized planetary-scale modeling, decision-making, and automation. Our goal is to help humanity address
          21st-century challenges like climate change and AI alignment, fostering a positive future for our planet.
        </p>
        <span className=" flex flex-col gap-4">
          <div className=" text-slate-500 flex flex-row italic gap-2">
            <p>Stay Informed </p>
            <p>|</p>
            <p>Join the team</p>
            <p>|</p>
